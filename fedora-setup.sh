...
sudo dnf -y install wget curl bash htop vim gvim nano git gcc make ShellCheck python3.7 python3-devel python3-virtualenv ncurses ncurses-devel firefox gnome-tweaks postgresql-server postgresql-contrib libxcrypt-compat golang mc
